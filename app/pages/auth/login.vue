...
<template>
  <div class="flex flex-col gap-8">
    ...
    <form class="flex flex-col gap-4" novalidate @submit.prevent="onSubmit">
      ...
      <!-- Guest -->
      <UButton type="button" color="primary" variant="outline" size="lg" block trailing-icon="i-heroicons-user-20-solid"
        @click="router.push('/')">
        {{ t('login.guestButton') }}
      </UButton>
    ...
    <!-- ── GOOGLE ──────────────────────────────────────── -->
    <UButton type="button" color="neutral" variant="ghost" size="lg" block class="-mt-2">
      <template #leading>
