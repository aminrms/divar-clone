...
<template>
  <div class="flex flex-col gap-4">
    ...
    <form class="flex flex-col gap-4" novalidate @submit.prevent="onSubmit">
      ...
      <!-- Forgot Password -->
      <div class="flex justify-end mb-9.25">
        <NuxtLink
          to="/auth/forgot-password"
          class="text-[10px] font-semibold text-primary hover:text-primary-400 hover:underline transition-colors"
        >
    ...
    <div class="flex items-center gap-3 justify-center w-full">
      <div class="w-2.5 h-px bg-primary-800" />
      <span class="text-[16px] text-gray-474 whitespace-nowrap font-medium">
    ...
    <p class="text-center text-sm text-gray-500 -mt-2">
      ...
      <NuxtLink
        to="/auth/register"
        class="text-primary-900 font-semibold hover:text-primary-800 hover:underline transition-colors ml-1"
      >
        {{ t('login.signUpLink') }}
      </NuxtLink>
    </p>
